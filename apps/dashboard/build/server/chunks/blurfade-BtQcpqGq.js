import { o as getContext, a as store_get, f as ensure_array_like, u as unsubscribe_stores, c as bind_props, s as setContext, B as slot, C as sanitize_props, D as rest_props, A as invalid_default_snippet, l as attr_class, j as clsx } from './index2-Eg0dVEDW.js';
import './Cropper.svelte_svelte_type_style_lang-CEajC662.js';
import { c as cn } from './index6-DijlZyMe.js';
import { a4 as fallback } from './utils2-DPSDgWhA.js';
import { w as writable, g as get, r as readable, d as derived } from './index-AIbsv2Pd.js';
import { t as tick, o as onDestroy } from './index-server-CicpYXzh.js';
...
var warning = dist.warning = function() {
};
var invariant = dist.invariant = function() {
};
if (process.env.NODE_ENV !== "production") {
  warning = dist.warning = function(check, message) {
    if (!check && typeof console !== "undefined") {
      console.warn(message);
    }
  };
  invariant = dist.invariant = function(check, message) {
    if (!check) {
...
function UseFeatures($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let visualElement2 = $$props["visualElement"];
    let props = $$props["props"];
    let features = [];
    {
      features = [];
...
function Motion($$renderer, $$props) {
  ...
  $$renderer.component(($$renderer2) => {
    ...
    ({ isStatic } = store_get($$store_subs ??= {}, "$a", a2) || {});
...
function PresenceChild($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let isPresent2 = $$props["isPresent"];
    let onExitComplete = fallback($$props["onExitComplete"], void 0);
    let initial = $$props["initial"];
    let custom = fallback($$props["custom"], void 0);
    let presenceAffectsLayout = $$props["presenceAffectsLayout"];
    let isCustom = $$props["isCustom"];
...
function AnimatePresence($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let isl, forceRender;
    let list = fallback($$props["list"], void 0);
    let custom = fallback($$props["custom"], void 0);
    let initial = fallback($$props["initial"], true);
    let onExitComplete = fallback($$props["onExitComplete"], void 0);
    let exitBeforeEnter = fallback($$props["exitBeforeEnter"], void 0);
    let presenceAffectsLayout = fallback($$props["presenceAffectsLayout"], true);
    let show = fallback($$props["show"], void 0);
    let isCustom = fallback($$props["isCustom"], false);
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      PresenceChild($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<!--[-->`);
          slot($$renderer3, $$props, "default", { item: child.item });
          $$renderer3.push(`<!--]-->`);
        },
        $$slots: { default: true }
      });
      ...
      $$slots: {
        default: ($$renderer3, { _item }) => {
          motion($$renderer3, {
            ...
            children: invalid_default_snippet,
            $$slots: {
              default: ($$renderer4, { motion: motion2 }) => {
                $$renderer4.push(`<div${attr_class(clsx(cn(className)))}>`);
                children?.($$renderer4);
                $$renderer4.push(`<!----></div>`);
              }
            }
...
export { Blurfade as B, motion as a, motionValue as m, sync as s };
//# sourceMappingURL=blurfade-BtQcpqGq.js.map
