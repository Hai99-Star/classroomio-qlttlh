  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      Label$1($$renderer3, spread_props([
        {
          "data-slot": "label",
          class: cn("ui:flex ui:select-none ui:items-center ui:gap-2 ui:text-sm ui:font-medium ui:leading-none ui:peer-disabled:cursor-not-allowed ui:peer-disabled:opacity-50 ui:group-data-[disabled=true]:pointer-events-none ui:group-data-[disabled=true]:opacity-50", className)
        },
        restProps,
        {
          get ref() {
...
export { Label as L };
//# sourceMappingURL=label-CXfFBnqp.js.map
