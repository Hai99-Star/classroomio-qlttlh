...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("15160za", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Question - ClassroomIO</title>`);
      });
    });
    Community_question($$renderer2, { slug: data.slug, backHref: resolve(communityPath, {}) });
  });
}

export { _page as default };
//# sourceMappingURL=_page.svelte-CAzeRfcH.js.map
