...
import { M as MenuRootState, k as MenuMenuState, P as Portal, l as DropdownMenuTriggerState, m as MenuContentState, o as MenuItemState, q as MenuSubmenuState } from './scroll-lock-BXzTpNNH.js';
import { n as noop, e as boxWith, d as createId, m as mergeProps } from './create-id-D7gdjJzW.js';
      ...
      Menu_item($$renderer3, spread_props([
        {
          ...
          class: cn("ui:data-highlighted:bg-accent ui:data-highlighted:text-accent-foreground ui:data-[variant=destructive]:text-destructive ui:data-[variant=destructive]:data-highlighted:bg-destructive/10 ui:dark:ui:data-[variant=destructive]:data-highlighted:bg-destructive/20 ui:data-[variant=destructive]:data-highlighted:text-destructive ui:data-[variant=destructive]:*:[svg]:text-destructive! ui:[&_svg:not([class*='text-'])]:text-muted-foreground ui:outline-hidden ui:relative ui:flex ui:cursor-default ui:select-none ui:items-center ui:gap-2 ui:rounded-sm ui:px-2 ui:py-1.5 ui:text-sm ui:data-disabled:pointer-events-none ui:data-inset:pl-8 ui:data-disabled:opacity-50 ui:[&_svg:not([class*='size-'])]:size-4 ui:[&_svg]:pointer-events-none ui:[&_svg]:shrink-0", className)
        },
        restProps,
        {
          get ref() {
...
export { Dropdown_menu_trigger as D, Root as R, Sub as S, Dropdown_menu_content as a, Dropdown_menu_item as b };
//# sourceMappingURL=index12-CJhCFtIc.js.map
