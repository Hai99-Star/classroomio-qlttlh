...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<div class="flex min-h-screen w-full items-center justify-center"><div>Logging you out...</div></div>`);
  });
}

export { _page as default };
//# sourceMappingURL=_page.svelte-vE5yhCNP.js.map
