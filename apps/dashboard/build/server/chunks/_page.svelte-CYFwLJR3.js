...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    head("w3qnhr", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>${escape_html(t.get("settings.auth.tabs.sso"))} - ClassroomIO</title>`);
      });
    });
...
//# sourceMappingURL=_page.svelte-CYFwLJR3.js.map
