...
import { a as isStudentCourseComplete } from './compliance-utils-UIprJIyn.js';
...
import './create-course-button-CInJDwkg.js';
...
function Mylearning($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const coursesInProgress = coursesApi.enrolledCourses.filter((course) => !isCourseComplete(course));
    const coursesComplete = coursesApi.enrolledCourses.filter((course) => isCourseComplete(course));
    let tabs = [
      {
        label: `${store_get($$store_subs ??= {}, "$t", t)("my_learning.progress")} (${coursesInProgress.length})`,
        value: "1"
      },
      {
        label: `${store_get($$store_subs ??= {}, "$t", t)("my_learning.complete")} (${coursesComplete.length})`,
        value: "2"
      }
    ];
    let currentTab = "1";
            ...
            children: ($$renderer5) => {
              ...
              for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
                ...
                Underline_tabs_trigger($$renderer5, {
                  value: tab.value,
                  children: ($$renderer6) => {
                    $$renderer6.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)(tab.label))}`);
                  },
                  $$slots: { default: true }
                });
                $$renderer5.push(`<!---->`);
          ...
          Underline_tabs_content($$renderer4, {
            ...
            children: ($$renderer5) => {
              Courses($$renderer5, {
                ...
                emptyDescription: store_get($$store_subs ??= {}, "$t", t)("my_learning.any_progress"),
                emptyTitle: store_get($$store_subs ??= {}, "$t", t)("my_learning.not_in_progress"),
                isLMS: true,
          ...
          Underline_tabs_content($$renderer4, {
            ...
            children: ($$renderer5) => {
              Courses($$renderer5, {
                ...
                emptyDescription: store_get($$store_subs ??= {}, "$t", t)("my_learning.any_course"),
                emptyTitle: store_get($$store_subs ??= {}, "$t", t)("my_learning.not_completed"),
                isLMS: true,
                isLoading: coursesApi.isLoading,
                get searchValue() {
                  return searchValue;
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    head("8oqelb", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>My Learning - ClassroomIO</title>`);
      });
    });
    Page($$renderer2, {
      class: "w-full",
            ...
            Page_header_content($$renderer4, {
              children: ($$renderer5) => {
                Page_title($$renderer5, {
                  children: ($$renderer6) => {
                    $$renderer6.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)("my_learning.heading"))}`);
                  },
                  $$slots: { default: true }
                });
              },
...
//# sourceMappingURL=_page.svelte-Yh1cojB7.js.map
