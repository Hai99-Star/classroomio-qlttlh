...
const load = async ({ params, cookies }) => {
  ...
  try {
    ...
    const userCourseAnalytics = result.ok && result.body.data ? result.body.data : null;
    return {
      courseId,
      userId,
      userCourseAnalytics
...
//# sourceMappingURL=29-D_7zkXiA.js.map
