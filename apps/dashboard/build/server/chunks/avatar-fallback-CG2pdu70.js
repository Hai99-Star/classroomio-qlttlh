...
import { d as createId, e as boxWith, m as mergeProps, C as Context, b as attachRef, w as watch, a as createBitsAttrs } from './create-id-D7gdjJzW.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      Avatar$1($$renderer3, spread_props([
        {
          "data-slot": "avatar",
          class: cn("ui:relative ui:flex ui:size-8 ui:shrink-0 ui:overflow-hidden ui:rounded-full", className)
        },
        restProps,
        {
          get ref() {
      ...
      Avatar_fallback$1($$renderer3, spread_props([
        {
          ...
          class: cn("ui:bg-muted ui:flex ui:size-full ui:items-center ui:justify-center ui:rounded-full", className)
        },
        restProps,
        {
          get ref() {
...
//# sourceMappingURL=avatar-fallback-CG2pdu70.js.map
