...
import { A as Ask_community } from './ask-community-CzoUr0L2.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("je70oq", $$renderer2, ($$renderer3) => {
            ...
            Page_header_content($$renderer4, {
              children: ($$renderer5) => {
                ...
                Page_subtitle($$renderer5, {
                  children: ($$renderer6) => {
                    $$renderer6.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)("community.ask.page_subtitle"))}`);
                  },
                  $$slots: { default: true }
                });
                $$renderer5.push(`<!---->`);
...
//# sourceMappingURL=_page.svelte-CUUh64mB.js.map
