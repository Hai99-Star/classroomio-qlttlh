...
import { A as Ask_community_button, C as Community } from './community-B6sku17T.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let { data } = $$props;
    head("632x7k", $$renderer2, ($$renderer3) => {
      ...
      children: ($$renderer3) => {
            ...
            Page_header_content($$renderer4, {
              children: ($$renderer5) => {
                ...
                Page_subtitle($$renderer5, {
                  children: ($$renderer6) => {
                    $$renderer6.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)("community.page_subtitle"))}`);
                  },
                  $$slots: { default: true }
                });
                $$renderer5.push(`<!---->`);
        ...
        $$renderer3.push(`<!----> <!---->`);
        {
          let child = function($$renderer4) {
            Community($$renderer4, { questions: data.questions });
          };
...
//# sourceMappingURL=_page.svelte-DeJvIf9Q.js.map
