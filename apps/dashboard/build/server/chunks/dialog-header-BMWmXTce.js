...
import { D as Dialog_title$1 } from './dialog-title-Cob84UGI.js';
...
function Dialog_header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attributes({
      ...
      class: clsx(cn("ui:flex ui:flex-col ui:gap-2 ui:text-left", className)),
      ...restProps
    })}>`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div>`);
...
export { Dialog_header as D, Dialog_title as a };
//# sourceMappingURL=dialog-header-BMWmXTce.js.map
