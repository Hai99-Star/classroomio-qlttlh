...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    head("lyfa2b", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>${escape_html(t.get("settings.auth.title"))} - ClassroomIO</title>`);
      });
    });
...
//# sourceMappingURL=_page.svelte-j8Vmt2xA.js.map
