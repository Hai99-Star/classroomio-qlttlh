...
function getBaseMetaTags(url, orgSiteInfo) {
  const title = public_env.PUBLIC_APP_TITLE?.trim() || DEFAULT_TITLE;
  const description = public_env.PUBLIC_APP_DESCRIPTION?.trim() || DEFAULT_DESCRIPTION;
  const siteName = public_env.PUBLIC_APP_TITLE?.trim() || null || "ClassroomIO";
...
//# sourceMappingURL=0-NcsBMgMj.js.map
