import { d as getApiHeaders, c as classroomio } from './index4-DxtvI9Cx.js';
import { s as safeServerApi } from './server2-CLuZrePM.js';
import { D as DEFAULT_ORG_AUDIENCE_QUERY, g as getAudienceQueryFromSearchParams, t as toAudienceRequestQuery } from './audience-query-utils-DHNyhHub.js';
...
const load = async ({ parent, cookies, url }) => {
  ...
  const [audienceResult, coursesResult] = await Promise.all([
    ...
    safeServerApi(
      () => classroomio.organization.courses.$get({ query: { tags: void 0 } }, headers)
    )
  ]);
...
//# sourceMappingURL=46-D7x7nvi7.js.map
