...
import { P as Profile } from './profile-BIIE15mA.js';
...
import './upload-image-Cb40_J84.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("s8s82s", $$renderer2, ($$renderer3) => {
        ...
        Page_header_content($$renderer3, {
          children: ($$renderer4) => {
            ...
            Page_subtitle($$renderer4, {
              children: ($$renderer5) => {
                $$renderer5.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)("settings.profile.page_subtitle"))}`);
              },
              $$slots: { default: true }
            });
            $$renderer4.push(`<!---->`);
...
//# sourceMappingURL=_page.svelte-jsRjL1sy.js.map
