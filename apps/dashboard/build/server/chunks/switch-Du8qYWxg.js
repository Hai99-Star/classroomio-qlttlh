...
import { a as createBitsAttrs, d as createId, n as noop, e as boxWith, m as mergeProps, C as Context, b as attachRef, E as ENTER, S as SPACE, f as boolToEmptyStrOrUndef, a3 as getDataChecked, h as boolToStr, g as getAriaChecked, i as boolToTrueOrUndef } from './create-id-D7gdjJzW.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      Switch$1($$renderer3, spread_props([
        {
          "data-slot": "switch",
          class: cn("ui:data-[state=checked]:bg-primary ui:data-[state=unchecked]:bg-input ui:focus-visible:border-ring ui:focus-visible:ring-ring/50 ui:dark:data-[state=unchecked]:bg-input/80 ui:shadow-xs ui:inline-flex ui:h-[1.15rem] ui:w-8 ui:shrink-0 ui:items-center ui:rounded-full ui:border ui:border-transparent ui:outline-none ui:transition-all ui:focus-visible:ring-[3px] ui:disabled:cursor-not-allowed ui:disabled:opacity-50 peer", className)
        },
        restProps,
        {
          get ref() {
          ...
          children: ($$renderer4) => {
            ...
            Switch_thumb($$renderer4, {
              ...
              class: cn("ui:bg-background ui:dark:data-[state=unchecked]:bg-foreground ui:dark:data-[state=checked]:bg-primary-foreground ui:pointer-events-none ui:block ui:size-4 ui:rounded-full ui:ring-0 ui:transition-transform ui:data-[state=checked]:translate-x-[calc(100%-2px)] ui:data-[state=unchecked]:translate-x-0")
            });
            $$renderer4.push(`<!---->`);
          },
          $$slots: { default: true }
...
export { Switch as S };
//# sourceMappingURL=switch-Du8qYWxg.js.map
