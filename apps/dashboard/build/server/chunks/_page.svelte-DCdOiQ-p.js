...
import { d as DEFAULT_COURSE_SORT, C as CourseSortBy } from './page-load-progress.svelte_svelte_type_style_lang-JkRnsqMd.js';
...
function Explore($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      Courses($$renderer3, {
        ...
        emptyTitle: store_get($$store_subs ??= {}, "$t", t)("explore.empty_heading"),
        emptyDescription: store_get($$store_subs ??= {}, "$t", t)("explore.empty_description"),
        isExplore: true,
        isLMS: true,
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    head("1iizet6", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Explore - ClassroomIO</title>`);
      });
    });
    Page($$renderer2, {
      class: "w-full",
            ...
            Page_header_content($$renderer4, {
              children: ($$renderer5) => {
                Page_title($$renderer5, {
                  children: ($$renderer6) => {
                    $$renderer6.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$t", t)("explore.heading"))}`);
                  },
                  $$slots: { default: true }
                });
              },
...
//# sourceMappingURL=_page.svelte-DCdOiQ-p.js.map
