var k=e=>{throw TypeError(e)};var A=(e,o,t)=>o.has(e)||k("Cannot "+t);var i=(e,o,t)=>(A(e,o,"read from private field"),t?t.call(e):o.get(e)),r=(e,o,t)=>o.has(e)?k("Cannot add the same private member more than once"):o instanceof WeakSet?o.add(e):o.set(e,t);import{s as g,g as d,a as y,A as f}from"./DMkybXYI.js";import{c as n}from"./DCOUcLu6.js";import{s as S}from"./C_RNpsE7.js";import{B as C}from"./CHxUnEOE.js";function h(e){return e??"<paste-your-mcp-key>"}function $(e){return`claude mcp add-json classroomio '{
  "command": "npx",
